...
$compilerCandidates = @(
    $env:SEVERALUDO_TS4_PYTHON,
    (Join-Path (Split-Path -Parent $repoRoot) "SeveralUDO-recovery\tools\python37\python.exe"),
    (Join-Path $repoRoot "tools\python37\python.exe")
)
