...
- Duplicate names can match by a unique game life stage in both directions (for example, a parent and child sharing a name). Same-name, same-stage ambiguity remains protected; scans never guess.
...
Validation: nine focused matching/archive regressions plus existing Tray import and manual-portrait protection tests.
