...
OutputDir=..\release
OutputBaseFilename=Decades-Tracker-4.5.10-Setup
...
VersionInfoVersion=4.5.10.0
VersionInfoCompany={#MyAppPublisher}
VersionInfoDescription={#MyAppName} installer
VersionInfoProductName={#MyAppName}
VersionInfoProductVersion=4.5.10.0
