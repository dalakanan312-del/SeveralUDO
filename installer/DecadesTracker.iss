...
OutputDir=..\release
OutputBaseFilename=Decades-Tracker-4.6.21-Setup
...
VersionInfoVersion=4.6.21.0
VersionInfoCompany={#MyAppPublisher}
VersionInfoDescription={#MyAppName} installer
VersionInfoProductName={#MyAppName}
VersionInfoProductVersion=4.6.21.0
