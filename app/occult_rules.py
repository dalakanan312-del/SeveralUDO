...
OCCULT_FOLLOW_UPS = {
    ...
    "fairy_discovery": ("fairy_discovery_response",),
    "fairy_discovery_response": ("fairy_discovery_danger",),
...
AUTOMATIC_OCCULT_FOLLOW_UP_SPECS = {
    ...
    "fairy_discovery": ({"rule_key":"fairy_discovery_response", "target":"origin"},),
    "fairy_discovery_response": ({"rule_key":"fairy_discovery_danger", "target":"origin"},),
...
DEFAULT_OCCULT_RULES = [
    ...
    _rule("fairy_discovery_response", "Community response to a discovered fairy", "Fairy", "follow-up", "d6", "5-6", "1-2: Dismissed as folklore and secrecy is restored; 3-4: Fairy must leave or hide for one historical year; 5-6: Fairy persecution or hunt", "Automatically rolled after a fairy is discovered; the result is recorded on the Sim profile and storyline.", auto=False),
    _rule("fairy_discovery_danger", "Fairy persecution survival", "Fairy", "follow-up", "d6", "1-2", "1-2: Killed during the persecution; 3-4: Escapes but must leave the settlement; 5-6: Conceals their identity and remains", "Lethal follow-up only when the community response produces persecution or a hunt.", auto=False),
