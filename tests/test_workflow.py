...
class WorkflowTests(unittest.TestCase):
    ...
    def test_every_feature_stays_in_exactly_one_workflow_group(self):
        ...
        self.assertEqual(main.navigation_group_for('planner')['id'], 'planning')
        self.assertEqual(main.navigation_group_for('infinite-decades')['id'], 'planning')
        self.assertEqual(main.navigation_group_for('health')['id'], 'setup')
        self.assertEqual(main.navigation_group_for('names')['id'], 'reference')
            ...
            for label, href in tasks:
                ...
                if target.fragment:
                    if target.path not in cache:
                        cache[target.path] = PageLinks(self.get(target.path))
    ...
    def test_branch_page_uses_its_new_planning_breadcrumb(self):
        ...
        self.assertIn('Plan Ahead', breadcrumb)
